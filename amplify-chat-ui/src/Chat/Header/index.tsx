...
//import QchatLogo from "/src/_images/chat/header/qchat-logo.svg?react"
    ...
    <div className={styles.header}>
      ...
      <div className={styles.buttons}>
        ...
        >
          ...
          {!isMobile && (
            <div className={`qchat-tooltip ${styles.headerTooltip}`}>{localizations[configuration.lang].clear}</div>
          )}
        </button>
        {isMobile && (
          <button
          ...
          >
            ...
            {/* <div className={`qchat-tooltip ${styles.headerTooltip}`}>{localizations[configuration.lang].collapse}</div> */}
          </button>
        )}
      </div>
    </div>
